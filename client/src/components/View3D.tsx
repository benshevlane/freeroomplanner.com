...
const PREMIUM = {
  ...
  sofa2: "/models/p/540afeda12.glb",
  coffee: "/models/p/459b6353c6.glb",
  side: "/models/p/8b60e96cd6.glb",
  diningSq: "/models/p/1044c6428d.glb",
  bedWhite: "/models/p/effd92f906.glb",
};

const MODEL_MAP: Record<string, ModelDef> = {
  bed_double: { url: PREMIUM.bedA, targetH: 100 },
  bed_king: { url: PREMIUM.bedWhite, targetH: 100 }, // white bedding variant
