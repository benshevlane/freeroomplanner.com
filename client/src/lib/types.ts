...
export const FURNITURE_LIBRARY: FurnitureTemplate[] = [
  ...
  { type: "larder_unit", label: "Tall Larder Unit", width: 60, height: 60, category: "Kitchen", icon: "square" },
  { type: "fridge_american", label: "American Fridge Freezer", width: 90, height: 75, category: "Kitchen", icon: "refrigerator" },
  ...
  { type: "rug", label: "Rug", width: 200, height: 140, category: "Living", icon: "square" },
  { type: "sideboard", label: "Sideboard", width: 160, height: 45, category: "Living", icon: "square" },
  { type: "footstool", label: "Footstool / Ottoman", width: 60, height: 60, category: "Living", icon: "square" },
  ...
  { type: "bedside_table", label: "Bedside Table", width: 50, height: 40, category: "Bedroom", icon: "square" },
  { type: "chest_drawers", label: "Chest of Drawers", width: 80, height: 45, category: "Bedroom", icon: "square" },
  { type: "dressing_table", label: "Dressing Table", width: 100, height: 45, category: "Bedroom", icon: "square" },
  { type: "cot", label: "Cot", width: 75, height: 145, category: "Bedroom", icon: "bed-single" },
  ...
  { type: "dining_table_round", label: "Dining Table (Round)", width: 110, height: 110, category: "Dining", icon: "utensils" },
  { type: "dining_bench", label: "Dining Bench", width: 140, height: 35, category: "Dining", icon: "square" },
  { type: "bar_stool", label: "Bar Stool", width: 40, height: 40, category: "Dining", icon: "circle" },
  ...
  { type: "filing_cabinet", label: "Filing Cabinet", width: 40, height: 60, category: "Office", icon: "square" },
  { type: "shelving_unit", label: "Shelving Unit", width: 90, height: 30, category: "Office", icon: "square" },
  { type: "sofa_bed", label: "Sofa Bed", width: 160, height: 90, category: "Office", icon: "sofa" },
  ...
  { type: "door_sliding", label: "Sliding Door", width: 150, height: DEFAULT_WALL_THICKNESS, category: "Structure", icon: "door-open", mirrorable: true },
  { type: "door_patio", label: "Patio Doors", width: 180, height: DEFAULT_WALL_THICKNESS, category: "Structure", icon: "door-open", mirrorable: true },
  { type: "archway", label: "Archway / Opening", width: 90, height: DEFAULT_WALL_THICKNESS, category: "Structure", icon: "door-open" },
  ...
  { type: "chimney_breast", label: "Chimney Breast", width: 120, height: 35, category: "Structure", icon: "square" },
];
